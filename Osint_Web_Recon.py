...
GITHUB_URL = "https://github.com/Zaid-AK1"
...
""" + RESET)
    slow_print(f"{BOLD}{GREEN}        Welcome to Zaid AK Tool{RESET}\n", 0.01)
...
def username_osint():
   ...
   platforms = {
        ...
        "Fanfiction": f"https://fanfiction.net/u/{username}",
        "ArchiveOfOurOwn": f"https://archiveofourown.org/users/{username}",
        "Kickstarter": f"https://kickstarter.com/profile/{username}",
        "Indiegogo": f"https://indiegogo.com/people/{username}",
        ...
        "PubMed": f"https://pubmed.ncbi.nlm.nih.gov/?term={username}",
        "IEEE": f"https://ieeexplore.ieee.org/author/{username}",
        "ACM": f"https://dl.acm.org/profile/{username}",
        "Springer": f"https://link.springer.com/search?query={username}",
        "ScienceDirect": f"https://sciencedirect.com/science/article/abs/pii/{username}",
        "Nature": f"https://nature.com/articles?author={username}",
        "Science": f"https://sciencemag.org/content/{username}",
        "Cell": f"https://cell.com/action/doSearch?text={username}",
        "Lancet": f"https://thelancet.com/action/doSearch?text={username}",
        "NEJM": f"https://nejm.org/action/doSearch?text={username}",
        "JAMA": f"https://jamanetwork.com/journals/jama/search?text={username}",
        "BMJ": f"https://bmj.com/search?text={username}",
        "PubMedCentral": f"https://pmc.ncbi.nlm.nih.gov/articles/?term={username}",
        "BioRxiv": f"https://biorxiv.org/search/{username}",
        "arXiv": f"https://arxiv.org/search/?query={username}",
        "SSRN": f"https://ssrn.com/author={username}",
        "RePEc": f"https://repec.org/{username}",
        "EconPapers": f"https://econpapers.repec.org/author/{username}",
        "NBER": f"https://nber.org/papers/{username}",
        "CEPR": f"https://cepr.org/people/{username}",
        "WorldBank": f"https://worldbank.org/en/people/{username}",
        "IMF": f"https://imf.org/en/People/{username}",
        "UN": f"https://un.org/en/people/{username}",
        "WTO": f"https://wto.org/english/people/{username}",
        "OECD": f"https://oecd.org/people/{username}",
        "EU": f"https://europa.eu/people/{username}",
        "NASA": f"https://nasa.gov/people/{username}",
        "ESA": f"https://esa.int/people/{username}",
        "CERN": f"https://cern.ch/people/{username}",
        "Fermilab": f"https://fnal.gov/people/{username}",
        "SLAC": f"https://slac.stanford.edu/people/{username}",
        "Brookhaven": f"https://bnl.gov/people/{username}",
        "Argonne": f"https://anl.gov/people/{username}",
        "OakRidge": f"https://ornl.gov/people/{username}",
        "LawrenceLivermore": f"https://llnl.gov/people/{username}",
        "LosAlamos": f"https://lanl.gov/people/{username}",
        "Sandia": f"https://sandia.gov/people/{username}",
        "MIT": f"https://mit.edu/people/{username}",
        "Stanford": f"https://stanford.edu/people/{username}",
        "Harvard": f"https://harvard.edu/people/{username}",
        "Cambridge": f"https://cam.ac.uk/people/{username}",
        "Oxford": f"https://ox.ac.uk/people/{username}",
        "Princeton": f"https://princeton.edu/people/{username}",
        "Yale": f"https://yale.edu/people/{username}",
        "Columbia": f"https://columbia.edu/people/{username}",
        "Chicago": f"https://uchicago.edu/people/{username}",
        "Caltech": f"https://caltech.edu/people/{username}",
        "Berkeley": f"https://berkeley.edu/people/{username}",
        "UCLA": f"https://ucla.edu/people/{username}",
        "Michigan": f"https://umich.edu/people/{username}",
        "Penn": f"https://upenn.edu/people/{username}",
        "Duke": f"https://duke.edu/people/{username}",
        "Northwestern": f"https://northwestern.edu/people/{username}",
        "JohnsHopkins": f"https://jhu.edu/people/{username}",
        "NYU": f"https://nyu.edu/people/{username}",
        "USC": f"https://usc.edu/people/{username}",
        "CarnegieMellon": f"https://cmu.edu/people/{username}",
        "GeorgiaTech": f"https://gatech.edu/people/{username}",
        "UIUC": f"https://illinois.edu/people/{username}",
        "Purdue": f"https://purdue.edu/people/{username}",
        "Texas": f"https://utexas.edu/people/{username}",
        "Washington": f"https://washington.edu/people/{username}",
        "Wisconsin": f"https://wisc.edu/people/{username}",
        "Minnesota": f"https://umn.edu/people/{username}",
        "OhioState": f"https://osu.edu/people/{username}",
        "PennState": f"https://psu.edu/people/{username}",
        "Rutgers": f"https://rutgers.edu/people/{username}",
        "Maryland": f"https://umd.edu/people/{username}",
        "BostonUniversity": f"https://bu.edu/people/{username}",
        "BostonCollege": f"https://bc.edu/people/{username}",
        "Northeastern": f"https://northeastern.edu/people/{username}",
        "Tufts": f"https://tufts.edu/people/{username}",
        "Brandeis": f"https://brandeis.edu/people/{username}",
        "Emory": f"https://emory.edu/people/{username}",
        "Vanderbilt": f"https://vanderbilt.edu/people/{username}",
        "Rice": f"https://rice.edu/people/{username}",
        "NotreDame": f"https://nd.edu/people/{username}",
        "Georgetown": f"https://georgetown.edu/people/{username}",
        "GeorgeWashington": f"https://gwu.edu/people/{username}",
        "AmericanUniversity": f"https://american.edu/people/{username}",
        "Howard": f"https://howard.edu/people/{username}",
        "Hampton": f"https://hamptonu.edu/people/{username}",
        "Morehouse": f"https://morehouse.edu/people/{username}",
        "Spelman": f"https://spelman.edu/people/{username}",
        "Tuskegee": f"https://tuskegee.edu/people/{username}",
        "FAMU": f"https://famu.edu/people/{username}",
        "NCAT": f"https://ncat.edu/people/{username}",
        "MorganState": f"https://morgan.edu/people/{username}",
        "JacksonState": f"https://jsums.edu/people/{username}",
        "SouthernUniversity": f"https://subr.edu/people/{username}",
        "Grambling": f"https://gram.edu/people/{username}",
        "AlcornState": f"https://alcorn.edu/people/{username}",
        "MississippiValley": f"https://mvsu.edu/people/{username}",
        "ArkansasPineBluff": f"https://uapb.edu/people/{username}",
        "Langston": f"https://langston.edu/people/{username}",
        "VirginiaState": f"https://vsu.edu/people/{username}",
        "NorfolkState": f"https://nsu.edu/people/{username}",
        "BowieState": f"https://bowiestate.edu/people/{username}",
        "CoppinState": f"https://coppin.edu/people/{username}",
        "DelawareState": f"https://desu.edu/people/{username}",
        "UniversityDC": f"https://udc.edu/people/{username}",
        "LincolnUniversity": f"https://lincoln.edu/people/{username}",
        "CheyneyUniversity": f"https://cheyney.edu/people/{username}",
        "ElizabethCityState": f"https://ecsu.edu/people/{username}",
        "FayettevilleState": f"https://uncfsu.edu/people/{username}",
        "WinstonSalemState": f"https://wssu.edu/people/{username}",
        "NorthCarolinaCentral": f"https://nccu.edu/people/{username}",
        "SouthCarolinaState": f"https://scsu.edu/people/{username}",
        "AlbanyState": f"https://asurams.edu/people/{username}",
        "FortValleyState": f"https://fvsu.edu/people/{username}",
        "SavannahState": f"https://savannahstate.edu/people/{username}",
        "KentuckyState": f"https://kysu.edu/people/{username}",
        "TennesseeState": f"https://tnstate.edu/people/{username}",
        "AlabamaState": f"https://alasu.edu/people/{username}",
        "AlabamaAM": f"https://aamu.edu/people/{username}",
        "TexasSouthern": f"https://tsu.edu/people/{username}",
        "PrairieViewAM": f"https://pvamu.edu/people/{username}",
        "UniversityTexasRioGrandeValley": f"https://utrgv.edu/people/{username}",
        "UniversityTexasElPaso": f"https://utep.edu/people/{username}",
        "UniversityTexasSanAntonio": f"https://utsa.edu/people/{username}",
        "UniversityTexasArlington": f"https://uta.edu/people/{username}",
        "UniversityTexasDallas": f"https://utdallas.edu/people/{username}",
        "UniversityTexasAustin": f"https://utexas.edu/people/{username}",
        "TexasAM": f"https://tamu.edu/people/{username}",
        "TexasTech": f"https://ttu.edu/people/{username}",
        "UniversityHouston": f"https://uh.edu/people/{username}",
        "UniversityNorthTexas": f"https://unt.edu/people/{username}",
        "UniversityOklahoma": f"https://ou.edu/people/{username}",
        "OklahomaState": f"https://okstate.edu/people/{username}",
        "UniversityKansas": f"https://ku.edu/people/{username}",
        "KansasState": f"https://ksu.edu/people/{username}",
        "UniversityNebraskaLincoln": f"https://unl.edu/people/{username}",
        "UniversityNebraskaOmaha": f"https://unomaha.edu/people/{username}",
        "UniversityIowa": f"https://uiowa.edu/people/{username}",
        "IowaState": f"https://iastate.edu/people/{username}",
        "UniversityMissouri": f"https://missouri.edu/people/{username}",
        "MissouriState": f"https://missouristate.edu/people/{username}",
        "UniversityArkansas": f"https://uark.edu/people/{username}",
        "ArkansasState": f"https://astate.edu/people/{username}",
        "UniversityMississippi": f"https://olemiss.edu/people/{username}",
        "MississippiState": f"https://msstate.edu/people/{username}",
        "UniversityAlabama": f"https://ua.edu/people/{username}",
        "AuburnUniversity": f"https://auburn.edu/people/{username}",
        "UniversityGeorgia": f"https://uga.edu/people/{username}",
        "GeorgiaState": f"https://gsu.edu/people/{username}",
        "UniversityFlorida": f"https://ufl.edu/people/{username}",
        "FloridaState": f"https://fsu.edu/people/{username}",
        "UniversitySouthFlorida": f"https://usf.edu/people/{username}",
        "UniversityCentralFlorida": f"https://ucf.edu/people/{username}",
        "UniversityMiami": f"https://miami.edu/people/{username}",
        "FloridaInternational": f"https://fiu.edu/people/{username}",
        "UniversityColoradoBoulder": f"https://colorado.edu/people/{username}",
        "ColoradoState": f"https://colostate.edu/people/{username}",
        "UniversityDenver": f"https://du.edu/people/{username}",
        "UniversityUtah": f"https://utah.edu/people/{username}",
        "UtahState": f"https://usu.edu/people/{username}",
        "BrighamYoung": f"https://byu.edu/people/{username}",
        "UniversityNevadaLasVegas": f"https://unlv.edu/people/{username}",
        "UniversityNevadaReno": f"https://unr.edu/people/{username}",
        "UniversityArizona": f"https://arizona.edu/people/{username}",
        "ArizonaState": f"https://asu.edu/people/{username}",
        "UniversityNewMexico": f"https://unm.edu/people/{username}",
        "NewMexicoState": f"https://nmsu.edu/people/{username}",
        "UniversityTexasRioGrandeValley": f"https://utrgv.edu/people/{username}",
        "UniversityTexasElPaso": f"https://utep.edu/people/{username}",
        "UniversityTexasSanAntonio": f"https://utsa.edu/people/{username}",
        "UniversityTexasArlington": f"https://uta.edu/people/{username}",
